...
This folder is a **SpaceStation workspace**. A human may have it open in a browser right now,
...
- The CLI ships with SpaceStation: `bin/pluto-collab` in the
  [SpaceStation.jl repo](https://github.com/GroupTherapyOrg/SpaceStation.jl).
